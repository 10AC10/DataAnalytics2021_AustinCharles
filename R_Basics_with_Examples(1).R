...
rm(RPI,Rpi,isSnowing,temperature)
rm(myobject,R,newobject,myfirstobject)
...
vec_numeric_boolean <- c(TRUE,1824,3.14) #TRUE = 1 FALSE = 0
vec_numeric_boolean <- c(FALSE,1824,3.14)
vec_numeric_boolean
...
vec1[1]
vec2[2]
#vec2[1:] #doesnt run like in python
