...
post(fitK, file = kyphosis, title = "Classification Tree for Kyphosis") # might need to convert to PDF (distill)

pfitK<- prune(pfitK, cp=  pfitK$cptable[which.min(fitK$cptable[,"xerror"]),"CP"])
